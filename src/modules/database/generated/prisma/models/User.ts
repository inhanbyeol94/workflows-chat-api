...
export type UserUpdateOneRequiredWithoutChannelsNestedInput = {
    ...
    connect?: Prisma.UserWhereUniqueInput;
    update?: Prisma.XOR<
        Prisma.XOR<Prisma.UserUpdateToOneWithWhereWithoutChannelsInput, Prisma.UserUpdateWithoutChannelsInput>,
...
export type UserUpdateOneWithoutCreatedChannelsNestedInput = {
    ...
    connect?: Prisma.UserWhereUniqueInput;
    update?: Prisma.XOR<
        Prisma.XOR<Prisma.UserUpdateToOneWithWhereWithoutCreatedChannelsInput, Prisma.UserUpdateWithoutCreatedChannelsInput>,
        Prisma.UserUncheckedUpdateWithoutCreatedChannelsInput
    >;
};
...
export type UserUpdateOneRequiredWithoutCredentialNestedInput = {
    ...
    connect?: Prisma.UserWhereUniqueInput;
    update?: Prisma.XOR<
        Prisma.XOR<Prisma.UserUpdateToOneWithWhereWithoutCredentialInput, Prisma.UserUpdateWithoutCredentialInput>,
        Prisma.UserUncheckedUpdateWithoutCredentialInput
    >;
};
 ...
 * UserCountOutputType without action
 */
export type UserCountOutputTypeCountCreatedChannelsArgs<
    ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
> = {
...
export type UserOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
    runtime.Types.Extensions.GetOmit<
        'id' | 'role' | 'name' | 'profileImageUrl' | 'email' | 'phoneNumber' | 'employeeCode' | 'createdAt' | 'updatedAt' | 'deletedAt',
        ExtArgs['result']['user']
    >;
...
> {
     ...
     * @example
     * // Get one User
     * const modules.user = await prisma.modules.user.findUnique({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
     ...
     * @example
     * // Get one User
     * const modules.user = await prisma.modules.user.findUniqueOrThrow({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
     ...
     * @example
     * // Get one User
     * const modules.user = await prisma.modules.user.findFirst({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
     ...
     * @example
     * // Get one User
     * const modules.user = await prisma.modules.user.findFirstOrThrow({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
     ...
     *
     * // Get first 10 Users
     * const users = await prisma.modules.user.findMany({ take: 10 })
     *
     * // Only select the `id`
     * const userWithIdOnly = await prisma.modules.user.findMany({ select: { id: true } })
     *
     */
     ...
     * @example
     * // Create one User
     * const User = await prisma.modules.user.create({
     *   data: {
     ...
     * @example
     * // Create many Users
     * const modules.user = await prisma.modules.user.createMany({
     *   data: [
     *     // ... provide data here
     *   ]
     * })
    ...
    /**
     * Create many Users and returns the data saved in the modules.database.
     * @param {UserCreateManyAndReturnArgs} args - Arguments to create many Users.
     * @example
     * // Create many Users
     * const modules.user = await prisma.modules.user.createManyAndReturn({
     *   data: [
     *     // ... provide data here
     *   ]
     * })
     ...
     * const userWithIdOnly = await prisma.modules.user.createManyAndReturn({
     *   select: { id: true },
     *   data: [
     *     // ... provide data here
     *   ]
     ...
     * @example
     * // Delete one User
     * const User = await prisma.modules.user.delete({
     *   where: {
     ...
     * @example
     * // Update one User
     * const modules.user = await prisma.modules.user.update({
     *   where: {
     *     // ... provide filter here
     *   },
     *   data: {
     ...
     * @example
     * // Delete a few Users
     * const { count } = await prisma.modules.user.deleteMany({
     *   where: {
     *     // ... provide filter here
     *   }
     * })
     ...
     * @example
     * // Update many Users
     * const modules.user = await prisma.modules.user.updateMany({
     *   where: {
     *     // ... provide filter here
     *   },
     *   data: {
    ...
    /**
     * Update zero or more Users and returns the data updated in the modules.database.
     * @param {UserUpdateManyAndReturnArgs} args - Arguments to update many Users.
     * @example
     * // Update many Users
     * const modules.user = await prisma.modules.user.updateManyAndReturn({
     *   where: {
     *     // ... provide filter here
     *   },
     *   data: [
     ...
     * const userWithIdOnly = await prisma.modules.user.updateManyAndReturn({
     *   select: { id: true },
     *   where: {
     *     // ... provide filter here
     *   },
     ...
     * const modules.user = await prisma.modules.user.upsert({
     *   create: {
     *     // ... data to create a User
     *   },
     *   update: {
     ...
     * @example
     * // Count the number of Users
     * const count = await prisma.modules.user.count({
     *   where: {
...
> extends Prisma.PrismaPromise<T> {
    ...
    credential<T extends Prisma.User$credentialArgs<ExtArgs> = {}>(
        args?: Prisma.Subset<T, Prisma.User$credentialArgs<ExtArgs>>,
    ): Prisma.Prisma__UserCredentialClient<
        runtime.Types.Result.GetResult<Prisma.$UserCredentialPayload<ExtArgs>, T, 'findUniqueOrThrow', GlobalOmitOptions> | null,
        null,
        ExtArgs,
        GlobalOmitOptions
    >;
    ...
    createdChannels<T extends Prisma.User$createdChannelsArgs<ExtArgs> = {}>(
        args?: Prisma.Subset<T, Prisma.User$createdChannelsArgs<ExtArgs>>,
    ): Prisma.PrismaPromise<runtime.Types.Result.GetResult<Prisma.$ChannelPayload<ExtArgs>, T, 'findMany', GlobalOmitOptions> | Null>;
    /**
