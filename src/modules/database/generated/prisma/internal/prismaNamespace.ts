...
/**
 * Helper for filtering JSON entries that have `null` on the modules.database (empty on the db)
 *
...
> = {
    ...
    meta: {
        modelProps: 'channelUsers' | 'channel' | 'message' | 'userCredential' | 'user';
